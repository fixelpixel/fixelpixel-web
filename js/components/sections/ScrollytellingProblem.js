...
export const ScrollytellingProblem = () => {
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {problems.map((problem, index) => (
            <div
              key={problem.title}
              className={`glass-morphism rounded-3xl p-8 transition-all duration-700 ${
                isVisible 
        ...
        {/* Comparison Table */}
        <div 
          className={`glass-morphism-strong rounded-3xl p-8 md:p-12 transition-all duration-1000 ${
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h4 className="text-xl font-bold text-red-400">Illusion Mode</h4>
              </div>
              {[
                ...
                <div key={metric.label} className="flex items-center justify-between p-4 rounded-xl bg-slate-900/50 border border-red-500/10">
                  <span className="text-slate-300">{metric.label}</span>
                  <span className="font-mono font-bold text-red-400">{metric.value}</span>
                </div>
              ))}
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h4 className="text-xl font-bold text-emerald-400">Truth Mode</h4>
              </div>
              {[
                ...
                <div key={metric.label} className="flex items-center justify-between p-4 rounded-xl bg-slate-900/50 border border-emerald-500/10">
                  <span className="text-slate-300">{metric.label}</span>
