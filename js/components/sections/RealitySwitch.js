...
const RealitySwitchMetric = ({ label, value, suffix, mode, isAnimating, color, inverse, icon }) => {
  ...
  return (
    <div className={`glass-morphism rounded-3xl p-8 transition-all duration-500 ${
    ...
    <section className="py-32 bg-slate-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-slate-400 max-w-3xl mx-auto mb-12">
        ...
        <div className="mt-16 grid md:grid-cols-2 gap-8">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={i} className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-red-500/20 flex items-center justify-center text-red-400 text-xs mt-0.5">✗</span>
          ...
          <div className="glass-morphism-strong rounded-3xl p-8 border-2 border-emerald-500/20">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={i} className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center text-emerald-400 text-xs mt-0.5">✓</span>
